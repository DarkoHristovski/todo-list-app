...
const ImportantToDo = ({ content, deleteTask, editTask}) => {
      ...
      <div className="todo-item">
        ...
        <div className="todo-bottom">
          <button
            ...
            className={
              completed===true ? "complete complete-btn" : "not-complete complete-btn"
            }
          >
            {completed ? "Completed" : "Uncompleted"}
          </button>
          <div className="btn-wrapper">
            <button onClick={importantHandler} className={important===true ? 'import-active' : ''}>
            ...
            <button onClick={() => openEditPopUp(content)} href="#">
              <i className="fa-regular fa-pen-to-square fa-2xl"></i>
            </button>
            <button onClick={() => deleteHandler(content.id)} href="#">
